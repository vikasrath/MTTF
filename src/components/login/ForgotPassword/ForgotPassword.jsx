...
function ForgotPassword({setResetPass}) {
    ...
    return (
        <form onSubmit={handleSubmit} className="mt-4 space-y-4">
            ...
            <button
                type="submit"
                className={`w-full bg-blue-600 text-white p-3 rounded-lg font-semibold hover:bg-blue-900 transition-all${verified == "verified" && passwordsMatch && formData.password.length >=8 ? "" : "  cursor-not-allowed bg-gray-400 hover:bg-gray-400"}`}
